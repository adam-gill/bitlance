...
const LandingPage =()=>{
    ...
    <div className="w-full h-screen  bg-primaryBitlanceDark  text-primaryBitlanceGray">
        <div className="flex flex-col gap-8 items-center w-full justify-center  h-full">
            <h1 className="text-6xl font-bold text-white ">Find Your Dream Job Today!
                
                </h1>
                <span>Connecting Talent with opportunity: Your Gateway to Career Success</span>

                <Button  disabled={true} className="w-1/2 h-12 text-4xl">BITLANCE</Button>
  ...
  <Image src="/svg/jobs.svg" alt="" width={20} height={10} className="bg-transparent"/>
</div>
<div>
...
<Card className="bg-transparent border-none">
  ...
  <CardContent className="flex gap-4">
  <div className="bg-primaryBitlanceLightGreen rounded-full h-10 w-10 flex items-center justify-center">
  <Image src="/svg/candidate.svg" alt="" width={20} height={10} className="bg-transparent"/>
</div>
<div>
...
<Card className="bg-transparent border-none">
  ...
  <CardContent className="flex gap-4">
  <div className="bg-primaryBitlanceLightGreen rounded-full h-10 w-10 flex items-center justify-center">
  <Image src="/svg/company.svg" alt="" width={20} height={10} className="bg-transparent"/>
</div>
<div>
